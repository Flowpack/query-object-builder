...
final class JoinDeleteBuilder extends DeleteBuilder
{
     ...
     */
    public function on(Exp $cond): DeleteBuilder
    {
        return $this->derive(DeleteBuilder::class, joins: $this->rebuildLastJoin(on: $cond));
    }

    /**
     * Set the USING columns for the last added join.
     */
    public function using(string ...$columns): DeleteBuilder
    {
        return $this->derive(DeleteBuilder::class, joins: $this->rebuildLastJoin(using: array_values($columns)));
    }

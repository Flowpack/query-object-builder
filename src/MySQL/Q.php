...
/**
 * Entry point (facade) for building queries: the statement entry points (SELECT,
 * INSERT, REPLACE, UPDATE, DELETE and WITH) plus the expression surface — literals,
 * arguments, facade-built operators/functions, CASE, EXISTS/ANY/ALL, window frame
 * bounds and the query-builder entry point. Dedicated function helpers live on
 * {@see Q\Func}.
 */
final class Q
{
    ...
    // Identifiers, literals and arguments
    ...
    // Boolean and arithmetic combinators

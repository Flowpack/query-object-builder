...
/**
 * The dialect-agnostic function set of the `Q\Func` facade: aggregates, the
 * string / regexp / numeric / date-time / JSON / misc scalar families, the window
 * functions and the special-shape builders. Both the MySQL and MariaDB facades
 * compose this trait (the two share one expression layer) and add only their
 * dialect-only functions.
 *
 * @internal
 */

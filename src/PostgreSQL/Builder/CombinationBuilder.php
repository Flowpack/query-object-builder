...
final class CombinationBuilder extends SelectBuilder
{
    ...
    {
        return $this->derive(self::class, combinations: $this->rebuildLastCombination(all: true));
    }

    public function query(SelectBuilder $query): self
    {
        return $this->derive(self::class, combinations: $this->rebuildLastCombination(query: $query));
    }

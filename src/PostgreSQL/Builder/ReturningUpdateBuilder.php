...
/**
 * The UPDATE builder state right after a RETURNING expression, where {@see as()}
 * sets the output name of that last expression.
 */
final class ReturningUpdateBuilder extends UpdateBuilder
{
    /**
     * Set the output name for the last RETURNING expression.
     */
    public function as(string $outputName): UpdateBuilder
    {
        ...
        return $this->derive(UpdateBuilder::class, returningItems: $returningItems);
    }
}
